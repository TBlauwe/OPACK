...
TEST_CASE("API Activity-DL")
{
	...
	SUBCASE("Simple tree")
	{
		...
		CHECK(*root.get<adl::LogicalConstructor>() == adl::LogicalConstructor::AND);
		CHECK(*root.get<adl::TemporalConstructor>() == adl::TemporalConstructor::SEQ_ORD);
		CHECK(adl::size(root) == 1);

		adl::action<Action1>(root);
		...
		CHECK(*instance.get<adl::LogicalConstructor>() == adl::LogicalConstructor::AND);
		CHECK(*instance.get<adl::TemporalConstructor>() == adl::TemporalConstructor::SEQ_ORD);
